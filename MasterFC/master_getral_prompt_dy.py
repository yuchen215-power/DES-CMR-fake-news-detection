...
from Models.FCWithEvidences import getral_prompt_dy as getral
...
def fit_models(args):
    ...
    secondary_log_folder = os.path.join(args.log, f"log_results_prompt_dy_{args.dataset}_{curr_date}")
